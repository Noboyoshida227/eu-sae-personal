  ...
  div(id = "main_app",
    ...
    tags$div(class = "wiz-step", style = "padding: 14px 20px 10px;",
      ...
      tags$ul(
        ...
        tags$li(tags$code("docs/instructions/EU_SAE_Download_Instructions_5_2_0_rc_6_wizard_5_6.pdf")),
        tags$li(tags$code("docs/instructions/EU_SAE_User_Guide_5_2_0_rc_6_wizard_5_6.pptx")),
