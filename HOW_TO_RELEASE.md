...
```powershell
python tools\bump_version.py 5.2.0-rc.6-wizard.5.1-greece --release-name EU_SAE_5.2.0_w6
```
...
```
## 5.2.0-rc.6-wizard.5.1-greece - 2026-09-10
...
tag* type `v5.2.0-rc.6-wizard.5.1-greece` and click *Create new tag on publish*.
