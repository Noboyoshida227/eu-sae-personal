  ...
  div(id = "main_app",
    ...
    sidebarPanel(
      ...
      tags$ul(
        ...
        tags$li(tags$code("docs/instructions/EU_SAE_Download_Instructions_5_2_0_rc_6_wizard_5_1.pdf")),
        tags$li(tags$code("docs/instructions/EU_SAE_User_Guide_5_2_0_rc_6_wizard_5_1.pptx")),
