#!/usr/bin/env bash
# ============================================================
#  EU SAE Dashboard - One-click launcher (macOS / Linux)
#
...
echo "============================================"
echo "   EU SAE Application - Classic Dashboard"
echo "============================================"
echo ""
echo "Starting up..."
...
#    first run).
#  - Then sources app.R directly. That file contains its own
